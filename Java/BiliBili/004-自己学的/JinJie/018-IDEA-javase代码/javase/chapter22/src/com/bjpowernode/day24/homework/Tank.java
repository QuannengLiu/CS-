 ...
 * 坦克是一个武器，可移动，可攻击。
 */
public class Tank extends com.bjpowernode.day24.homework.Weapon implements com.bjpowernode.day24.homework.Moveable, com.bjpowernode.day24.homework.Shootable {
    ...
    public static class Test {
        public static void main(String[] args) {
            // 构建一个军队
            com.bjpowernode.day24.homework.Army army = new Army(4); // 军队只有4个武器。
            // 创建武器对象
